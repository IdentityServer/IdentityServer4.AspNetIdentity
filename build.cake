    ...
    .Does(() =>
{
    ...
    if (isWindows)
    {
        DotNetCoreBuild(Directory("./src/IdentityServer4.AspNetIdentity"), settings);
        //DotNetCoreBuild(Directory("./test/IdentityServer4.AspNetIdentity.IntegrationTests"), settings);
        //DotNetCoreBuild(Directory("./test/IdentityServer4.AspNetIdentity.UnitTests"), settings);
